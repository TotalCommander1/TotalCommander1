...
ЗАГАЛЬНИЙ ПЛАН КРОКУ № 3
	...
	ІІІ. Створюємо ф-цію click_koshik() яка має реагувати на клік мишкою по зображенню кошика (клік по об'єкту з id ks ). 
	
	ІV. У функції click_koshik() створюємо метод ajax, який запускає на виконання файл show_table4.php. Файл show_table4.php повертає буть-який html код. Перевіряємо роботу 
	цього модуля.
...
Команда alert(data) написана для більшої наочності і у подальшому може бути видалена.  
*/
