...
?>
	...
	<tr>
		...
		<td valign='top'>
			...
			<span class='help_tovar'>	<? echo $row['help'] 	?>	<br></span>
			<span class='price_tovar'>	<? echo $row['price'] 	?>		</span>
			<span class='value_tovar'>	<? echo $row['valuta'] 	?>		</span>
			<span class='pre_tovar'>	<? echo $row['prefiks'] ?>		</span>
			<span class='unit_tovar'>	<? echo $row['unit'] 	?>		</span>
		</td>
	</tr>
